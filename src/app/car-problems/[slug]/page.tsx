          ...
          <aside className="rounded-3xl border border-slate-200 bg-white p-6 dark:border-slate-800 dark:bg-slate-900">
            ...
            {(() => {
              const brandSlugMap: Record<string, string> = {
                ...
                "Alfa Romeo": "alfa-romeo-workshop-singapore",
                "Land Rover": "land-rover-workshop-singapore",
                "Jaguar": "jaguar-workshop-singapore",
                "MINI": "mini-workshop-singapore",
                "Maserati": "maserati-workshop-singapore",
