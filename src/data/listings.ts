...
export const listings: Listing[] = [
  ...
  // === EV specialists ===
  { id: "ev01", title: "EV Care SG", category: "ev", specialties: ["EV","tesla","battery","charging","HV-system"], region: "central", area: "Tagore", priceFrom: 150, rating: 4.5, reviewCount: 60, brands: ["Tesla","BYD","BYD Atto 3","BYD Sealion","Hyundai EV","MG"], diagnosticTools: ["TeslaTM"], partsTier: "OEM", source: "verified-partner", sourceUrl: "https://www.google.com/maps/search/EV+Care+SG+Tagore", blurb: "Independent Tesla + BYD + EV specialist. 12V failures, charging faults, HV diagnostics, battery health checks.", verified: true, agentAlternative: true },
